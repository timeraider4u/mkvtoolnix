#ifndef MTX_MKVTOOLNIX_GUI_EXTRACTION_TOOL_TOOL_H
#define MTX_MKVTOOLNIX_GUI_EXTRACTION_TOOL_TOOL_H
...
protected:
  ...
  QMenu *m_extractionToolMenu;
  mtx::gui::Util::FilesDragDropHandler m_filesDDHandler;

public:
  explicit Tool(QWidget *parent, QMenu *extractionToolMenu);
  ~Tool();
...
protected:
  ...
  virtual void showExtractionToolWidget();
...
#endif // MTX_MKVTOOLNIX_GUI_EXTRACTION_TOOL_TOOL_H
